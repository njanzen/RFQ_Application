...
class RFQ_Application(tk.Tk):
    ...
    different windows used by the aplliction. It also initiallizes the main app
    ...
    def AddMenu(self, container):
        '''Initiallizes all the dropdown menus for the application.'''
...
class HomePage(tk.Frame):
    '''A class using the tk.Frame framework. HomePage is the main page initiallized
    application. It contains some of the basic RFQ settings as well as readouts like
    temp and pressure.'''
    def __init__(self, parent, controller):
        tk.Frame.__init__(self,parent) #Initiallizes as a tk Frame
